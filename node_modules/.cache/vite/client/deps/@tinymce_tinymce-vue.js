...
import { h, defineComponent, onMounted, ref, toRefs, nextTick, watch as watch2, onBeforeUnmount, onActivated, onDeactivated } from "vue";
...
var Editor = defineComponent({
  ...
  setup: function(props, ctx) {
    ...
    watch2(readonly, function(isReadonly) {
      if (vueEditor !== null) {
        setMode(vueEditor, isReadonly ? "readonly" : "design");
      }
    });
    watch2(disabled, function(isDisabled) {
      if (vueEditor !== null) {
