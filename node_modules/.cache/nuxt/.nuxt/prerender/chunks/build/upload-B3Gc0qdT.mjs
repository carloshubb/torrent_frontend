...
import { ssrRenderAttrs } from 'file://D:/_4_Work/Web/torrent-nuxt/frontend/node_modules/vue/server-renderer/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "pt-5 bg-gradient-to-r from-gray-350 to-gray-500" }, _attrs))}><h1>UPLOADER</h1></div>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/navibar/upload.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const upload = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { upload as default };
//# sourceMappingURL=upload-B3Gc0qdT.mjs.map
